...
object BitmapUtil {
    ...
    fun combineBitmap_Title(context: Context?, titleStr: String, view: View?): Bitmap? {
        ...
        val bitmap =
            if (view is ScrollView) convertViewToBitmap((view as ScrollView?)!!) else convertViewToBitmap(
                view
            )
        ...
        // 绘制标题文字
        titleCanvas.drawText(
            titleStr,
            bitmap.width / 2 - textWidth / 2,
