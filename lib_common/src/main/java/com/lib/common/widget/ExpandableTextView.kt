...
class ExpandableTextView : LinearLayout, View.OnClickListener {
    ...
    internal inner class ImageButtonExpandController(private val mExpandDrawable: Drawable, private val mCollapseDrawable: Drawable) :
    ...
    internal class TextViewExpandController(private val mExpandText: String, private val mCollapseText: String) :
        ExpandIndicatorController {
