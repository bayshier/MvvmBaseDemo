...
//        View view = LayoutInflater.from(getContext()).inflate(com.imagepicker.R.layout.picker_item_camera, null);
//        TextView mTvvCamera = view.findViewById(com.imagepicker.R.id.tv_camera);
