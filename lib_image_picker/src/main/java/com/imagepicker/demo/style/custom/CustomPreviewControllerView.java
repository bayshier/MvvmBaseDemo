package com.imagepicker.demo.style.custom;
...
import com.imagepicker.adapter.MultiPreviewAdapter;
...
import com.imagepicker.helper.recyclerviewitemhelper.SimpleItemTouchHelperCallback;
...
public class CustomPreviewControllerView extends PreviewControllerView {
    ...
    private void refreshNextBtn() {
        ...
        if (index >= 0) {
            ...
            mTvIndex.setText("");
            mTvIndex.setBackground(getResources().getDrawable(com.imagepicker.R.mipmap.picker_icon_unselect));
        }
